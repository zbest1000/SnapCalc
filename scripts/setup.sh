...
echo ""
echo "🔧 Optional: Enhanced OCR Setup"
echo "For better OCR accuracy with PaddleOCR, run:"
echo "  ./scripts/setup-paddleocr.sh"
echo ""
echo "Next steps:"
...
echo "- docs/PADDLEOCR_SETUP.md - PaddleOCR integration guide"